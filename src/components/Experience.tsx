  ...
  const jobs: Job[] = [
    ...
    },
    {
      ...
      description: [
        ...
        "Designed and deployed a scalable backend RESTful API leveraging Python, OCR (Azure), and generative AI to process thousands of PDF data, automating tabular data indexing, natural language querying, and dynamic chart generation.",
    ...
    },
    {
      ...
      technologies: ["Full-stack", "B2B SaaS", "DevOps", "Agile", "Cloud Infrastructure", "CI/CD"]
    }
  ];

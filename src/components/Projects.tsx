...
import { Calendar, Github, GitBranch, ExternalLink } from "lucide-react";
  ...
  const projects: Project[] = [
    {
      ...
      repoLink:
        "https://github.com/benruckman/Data-Visualization-Final-Project",
      featured: true,
      images: [
        "/lovable-uploads/fc41ee6f-03e5-43ec-806c-664c46d162aa.png",
        "/lovable-uploads/3c0c87dd-1c8c-4191-bf7e-2163ae56ef67.png",
        "/lovable-uploads/82b48878-128e-41de-bb19-eccf50042108.png",
      ],
    },
    {
      ...
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {projects.map((project, index) => (
            <Card
              key={index}
              className={`h-full flex flex-col border border-border/60 hover:shadow-md transition-shadow ${
